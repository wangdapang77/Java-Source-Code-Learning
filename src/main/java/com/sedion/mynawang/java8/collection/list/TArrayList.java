...
/**
 * 定义：
 *  ArrayList支持泛型，继承AbstractList，而AbstractList实现了List接口，提供List接口的默认实现
 ...
 */
public class TArrayList<E> //extends AbstractList<E> implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
    /**********************************属性***********************************/
